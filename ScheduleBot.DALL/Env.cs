...
namespace ScheduleBot.DALL
{
    ...
    {
        public static readonly string BOT_API_TOKEN = "5532128951:AAHeDzFahgwu-2AV99TbL69zbI5YaYtcUrk";
        ...
        public static readonly string GoogleDriveArchive = "https://drive.google.com/drive/folders/1pcaDQ4vOiWyAk_DJhyVViK5U-a45n8qn";
    ...
    {
        public readonly List<string> Bakalavr1_Groups = new List<string>()
        { "C4:C23", "D4:D23", "E4:E23", "F4:F23", "G4:G23", "H4:H23" };
